    ...
    <div class="flex flex-1 overflow-hidden">
      ...
      <aside class="w-64 bg-white shadow-lg flex-shrink-0 border-r border-gray-300">
        <div class="p-6">
          ...
          <nav class="space-y-2">
            ...
            <a href="{{ route('dosen.index') }}" class="flex items-center gap-2 py-2 px-4 rounded-lg text-gray-700 hover:bg-blue-100 transition">
      ...
      <main class="flex-1 p-8 overflow-y-auto bg-white border-l border-gray-300">
        ...
        <div class="mb-6">
          ...
          <p class="text-gray-500">Selamat datang di halaman utama sistem informasi akademik.</p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div class="bg-white border rounded-xl shadow p-6 flex items-center gap-4">
            ...
            <div>
              ...
              <p class="text-2xl font-bold text-gray-700">4</p>
            </div>
          </div>
          ...
          <div class="bg-white border rounded-xl shadow p-6 flex items-center gap-4">
            ...
            <div>
              ...
              <p class="text-2xl font-bold text-gray-700">120</p>
            </div>
          </div>
