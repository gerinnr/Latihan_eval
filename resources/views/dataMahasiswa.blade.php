          ...
          <table class="min-w-full table-auto text-sm">
            <thead>
              <tr class="bg-blue-200 text-gray-800 uppercase text-xs">
                ...
                <th class="py-3 px-4 text-center border">ID Mahasiswa</th>
            ...
            <tbody id="mahasiswaTableBody">
              ...
              <tr class="hover:bg-blue-50 border-b">
                ...
                <td class="py-2 px-4 text-center">{{ $mhs['id'] }}</td>
                <td class="py-2 px-4">{{ $mhs['nama'] }}</td>
                <td class="py-2 px-4">{{ $mhs['nim'] }}</td>
                <td class="py-2 px-4">{{ $mhs['email'] }}</td>
                <td class="py-2 px-4">{{ $mhs['prodi'] }}</td>
                <td class="py-2 px-4 text-center space-x-1">
                  <a href="{{ route('mahasiswa.edit', $mhs['nim']) }}" class="bg-yellow-400 text-white px-3 py-1 rounded hover:bg-yellow-500 transition">
